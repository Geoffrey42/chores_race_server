defmodule ChoresRaceServerWeb.ArticleController do
  use ChoresRaceServerWeb, :controller

  alias ChoresRaceServer.News
  alias ChoresRaceServer.News.Article

  action_fallback ChoresRaceServerWeb.FallbackController
